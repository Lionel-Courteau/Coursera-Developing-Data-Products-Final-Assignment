...
shinyUI(navbarPage("Shiny Application",
                   ...
                   tabPanel("About the Data Set",
                            ...
                            helpText("You work for Motor Trend, a magazine about the automobile industry Looking at a data set of a collection of cars, they are interested in exploring the relationship ",
                                     ...
                                     "They are particularly interested in the following two questions: Is an automatic or manual transmission better for MPG.", 
                   ...
                   tabPanel("Go back to my Github repository",
                            a("https://github.com/Lionel-Courteau/Coursera-Developing-Data-Products-Final-Assignment"),
                            hr(),
                            h4("I hope you like this Shiny App"),
                            h4("The name of the repository is Coursera Developing Data Products Final-Assignment")
                   )
))
